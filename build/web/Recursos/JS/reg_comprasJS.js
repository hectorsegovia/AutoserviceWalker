...
function generarRegistrarCompra() {
    accion = 1;
...
function aprobarregistrarcompra() {
    accion = 11;
    aprobar();
}
...
function grabarRegistrarCompras() {
    switch (accion) {
        case 1:
            verificar();
            break;
...
function prepararJsonRegCompra(ban) {
    var combo = document.getElementById("id_condicioncompra");
...
//var jsonCabDet;
    ...
    RegCompraJSON = {
        "bandera": ban,
        "fecha": $('#fecha_factura').val().length <= 0 ? "0" : $('#fecha_factura').val(),
    ...
    (function sumarDias(){
        ...
        var fecha = new Date(),
            ...
            for (var x=0; x <= 3; x++ ){
                ...
                alert("Fecha final: " + fecha.getDate() + "/" + (fecha.getMonth() + 1) + "/" + fecha.getFullYear());
                ...
                for (x in json) {
                    ...
                    for (d in json[x].lista_mercaderias) {
                        $('#tabladetalleRegCompra').append("<tr id=\'prod" + tindex + "\'>\n\
                                ...
                                <td style=' width: 5%;'>" + json[x].lista_mercaderias[d].precio + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].cantidad + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].cantidad_recibida + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].exenta + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].iva5 + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].iva10 + "</td>\n\
                                \n\<td style=' width: 5%;'>" + json[x].lista_mercaderias[d].total + "</td>\n\
...
function getTDorden(obj) {
    ...
    document.getElementById('nro_recepcion').value = varTR[1].innerHTML;
