...
import Modelos.DAOIMPL.AperturacajaDAOIMPL;
 ...
 * @author AspireES15
 */
public class AperturacajaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        AperturacajaDTO dto = jsonAObjeto.fromJson(json, AperturacajaDTO.class);
       ...
       // dto.setId(3);
        ...
        AperturacajaDAO dao=new AperturacajaDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_apertura()));
            ...
            break;
             case 6:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String datoss= jsonAObjeto.toJson(dao.getListCajas());
            ...
            break;
             case 7:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String datosss= jsonAObjeto.toJson(dao.getListSucursal());
            ...
            case 8:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String datossss= jsonAObjeto.toJson(dao.getListResponsables());
