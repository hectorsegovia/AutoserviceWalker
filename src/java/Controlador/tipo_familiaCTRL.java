...
import Modelos.DAOIMPL.tipo_familiaDAOIMPL;
 ...
 * @author AspireES15
 */
public class tipo_familiaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        tipo_familiaDTO dto = jsonAObjeto.fromJson(json, tipo_familiaDTO.class);
       ...
       // dto.setId(3);
        ...
        tipo_familiaDAO dao=new tipo_familiaDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_tifamilia()));
