...
import Modelos.DAOIMPL.EstadoDAOIMPL;
 ...
 * @author AspireES15
 */
public class EstadosCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EstadoDTO dto = jsonAObjeto.fromJson(json, EstadoDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_estado()));
