...
import Modelos.DAOIMPL.ImpuestoDAOIMPL;
 ...
 * @author AspireES15
 */
public class ImpuestoCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        ImpuestoDTO dto = jsonAObjeto.fromJson(json, ImpuestoDTO.class);
       ...
       // dto.setId(3);
        ...
        ImpuestoDao dao=new ImpuestoDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_impuesto()));
