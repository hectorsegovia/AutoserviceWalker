...
import Modelos.DAOIMPL.tipo_cobroDAOIMPL;
 ...
 * @author AspireES15
 */
public class Tipo_cobroCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        tipo_cobroDTO dto = jsonAObjeto.fromJson(json, tipo_cobroDTO.class);
       ...
       // dto.setId(3);
        ...
        Tipo_cobroDAO dao=new tipo_cobroDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_ticobro()));
