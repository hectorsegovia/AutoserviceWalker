...
import Modelos.DAOIMPL.CajasDAOIMPL;
 ...
 * @author AspireES15
 */
public class CajasCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        CajasDTO dto = jsonAObjeto.fromJson(json, CajasDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_caja()));
