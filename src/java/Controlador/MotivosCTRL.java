...
import Modelos.DAOIMPL.MotivoDAOIMPL;
 ...
 * @author AspireES15
 */
public class MotivosCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        MotivoDTO dto = jsonAObjeto.fromJson(json, MotivoDTO.class);
       ...
       // dto.setId(3);
        ...
        motivoDAO dao=new MotivoDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_motivo()));
