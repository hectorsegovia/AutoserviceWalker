...
import Modelos.DAOIMPL.Tipo_facturasDAOIMPL;
 ...
 * @author AspireES15
 */
public class Tipo_facturaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Tipo_facturaDTO dto = jsonAObjeto.fromJson(json, Tipo_facturaDTO.class);
       ...
       // dto.setId(3);
        ...
        tipo_facturaDAO dao=new Tipo_facturasDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_tifactura()));
