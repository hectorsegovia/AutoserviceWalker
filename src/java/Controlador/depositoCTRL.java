...
import Modelos.DAOIMPL.depositosDAOIMPL;
 ...
 * @author AspireES15
 */
public class depositoCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        depositoDTO     dto = jsonAObjeto.fromJson(json, depositoDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_deposito()));
            ...
            break;
             case 6:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String ListaSuc= jsonAObjeto.toJson(dao.getListSucursales());
                System.out.println(ListaSuc);
                if (ListaSuc != null) {
                    out.println(ListaSuc);
                    out.close();
                }
