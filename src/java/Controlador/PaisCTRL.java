...
import Modelos.DAOIMPL.PaisDAOIMPL;
 ...
 * @author AspireES15
 */
public class PaisCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PaisDTO dto = jsonAObjeto.fromJson(json, PaisDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_pais()));
