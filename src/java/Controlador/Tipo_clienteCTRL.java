...
import Modelos.DAOIMPL.Tipo_clienteDAOIMPL;
 ...
 * @author AspireES15
 */
public class Tipo_clienteCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Tipo_clienteDTO dto = jsonAObjeto.fromJson(json, Tipo_clienteDTO.class);
       ...
       // dto.setId(3);
        ...
        Tipo_clienteDAO dao=new Tipo_clienteDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_ticliente()));
