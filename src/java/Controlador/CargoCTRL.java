...
import Modelos.DAOIMPL.CargoDAOIMP;
 ...
 * @author AspireES15
 */
public class CargoCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CargoDTO dto = jsonAObjeto.fromJson(json, CargoDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_cargo()));
