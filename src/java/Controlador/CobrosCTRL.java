...
import Modelos.DAOIMPL.CobrosDAOIMPLE;
 ...
 * @author AspireES15
 */
public class CobrosCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Gson gson = new Gson();
        CobrosDTO dto = gson.fromJson(json, CobrosDTO.class);

        CobroDAO dao = new CobrosDAOIMPLE();
        switch (dto.getBandera()) {
            case 4:
                dao.generarcobros(dto);
                break;
            case 5:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String datosssss = gson.toJson(dao.getListSucursal());
