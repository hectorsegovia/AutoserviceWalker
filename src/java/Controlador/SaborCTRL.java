...
import Modelos.DAO.SaborDAO;
import Modelos.DAOIMPL.SaborDAOIMPL;
 ...
 * @author AspireES15
 */
public class SaborCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        SaborDTO dto = jsonAObjeto.fromJson(json, SaborDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_sabor()));
