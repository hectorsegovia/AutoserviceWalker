...
import Modelos.DAOIMPL.Tipo_chequeDAOIMPL;
 ...
 * @author AspireES15
 */
public class Tipo_chequeCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Tipo_chequeDTO dto = jsonAObjeto.fromJson(json, Tipo_chequeDTO.class);
       ...
       // dto.setId(3);
        ...
        Tipo_chequeDAO dao=new Tipo_chequeDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_ticheque()));
