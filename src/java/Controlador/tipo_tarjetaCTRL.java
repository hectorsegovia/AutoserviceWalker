...
import Modelos.DAOIMPL.tipo_tarjetasDAOIMPL;
 ...
 * @author AspireES15
 */
public class tipo_tarjetaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        tipo_tarjetasDTO dto = jsonAObjeto.fromJson(json, tipo_tarjetasDTO.class);
       ...
       // dto.setId(3);
        ...
        tipo_tarjetaDAO dao=new tipo_tarjetasDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_titarjeta()));
