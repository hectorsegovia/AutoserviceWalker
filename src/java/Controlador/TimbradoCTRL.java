...
import Modelos.DAOIMPL.TimbradoDAOIMPL;
 ...
 * @author AspireES15
 */
public class TimbradoCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TimbradoDTO dto = jsonAObjeto.fromJson(json, TimbradoDTO.class);
       ...
       // dto.setId(3);
        ...
        TimbradoDAO dao=new TimbradoDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_timbrado()));
