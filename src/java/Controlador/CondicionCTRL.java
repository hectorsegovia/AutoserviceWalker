...
import Modelos.DAOIMPL.CondicionDAOIMPL;
 ...
 * @author AspireES15
 */
public class CondicionCTRL extends HttpServlet {
    ...
    response.setContentType("text/html;charset=UTF-8");
        ...
        CondicionDTO dto = jsonAObjeto.fromJson(json, CondicionDTO.class);
       ...
       // dto.setId(3);
        ...
        CondicionDAO dao=new CondicionDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_condicion()));
