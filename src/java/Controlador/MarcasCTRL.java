...
import Modelos.DAOIMPL.MarcasDAOIMPL;
 ...
 * @author AspireES15
 */
public class MarcasCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     response.setContentType("text/html;charset=UTF-8");
        ...
        MarcasDTO dto = jsonAObjeto.fromJson(json, MarcasDTO.class);
       ...
       // dto.setId(3);
        ...
        MarcasDAO dao=new MarcasDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_marca()));
