...
import Modelos.DAOIMPL.ClienteDAOIMPL;
...
public class ClienteCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ClienteDTO dto = jsonAObjeto.fromJson(json, ClienteDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_cliente()));
            ...
            break;
             case 6:
                System.out.println("Llegamos al caso 4");
                response.setContentType("application/json, charset=UTF-8");
                String datoss= jsonAObjeto.toJson(dao.getListTipoCliente());
