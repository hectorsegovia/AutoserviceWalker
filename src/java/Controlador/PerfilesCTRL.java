...
import Modelos.DAOIMPL.PerfilesDAOIMPL;
 ...
 * @author AspireES15
 */
public class PerfilesCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PerfilesDTO dto = jsonAObjeto.fromJson(json, PerfilesDTO.class);
       ...
       // dto.setId(3);
        ...
        PerfilesDAO dao=new PerfilesDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_perfil()));
