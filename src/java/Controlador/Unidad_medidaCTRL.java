...
import Modelos.DAOIMPL.UnidamedidaDAOIMPL;
 ...
 * @author AspireES15
 */
public class Unidad_medidaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      response.setContentType("text/html;charset=UTF-8");
        ...
        unidad_medidaDTO dto = jsonAObjeto.fromJson(json, unidad_medidaDTO.class);
       ...
       // dto.setId(3);
        ...
        Unidad_medidaDAO dao=new UnidamedidaDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_medida()));
