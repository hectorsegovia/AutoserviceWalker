...
import Modelos.DAOIMPL.RecepcionesDAOIMPL;
 ...
 */
public class RecepcionesCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Gson gson = new Gson();
        RecepcionDTO dto = gson.fromJson(json, RecepcionDTO.class);

        RecepcionesDAO dao = new RecepcionesDAOIMPL();
        switch (dto.getBandera()) {
            case 1:
                dao.reg_recepcion(dto);
                break;
            case 2:
                dao.anular_recepcion(dto);
                break;
            case 3:
                response.setContentType("application/json, charset=UTF-8");
                String jsonCabDet;
                jsonCabDet = gson.toJson(dao.recuperar_recepciones(dto));
            ...
            case 6:
                ...
                break;
            case 7:
                dao.aprobar_recepcion(dto);
                break;
            case 8:
                System.out.println("Llegamos al caso 6");
                response.setContentType("application/json, charset=UTF-8");
                String datosssss = gson.toJson(dao.getListcodigoS());
