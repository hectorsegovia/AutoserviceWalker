...
import Modelos.DAOIMPL.SucursalDAOIMP;
 ...
 * @author AspireES15
 */
public class SucursalCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        SucursalDTO dto = jsonAObjeto.fromJson(json, SucursalDTO.class);
       ...
       // dto.setId(3);
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_sucursal()));
