...
import Modelos.DAOIMPL.SubcategoriaDAOIMPL;
 ...
 * @author AspireES15
 */
public class SubcategoriaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     response.setContentType("text/html;charset=UTF-8");
        ...
        SubcategoriaDTO dto = jsonAObjeto.fromJson(json, SubcategoriaDTO.class);
       ...
       // dto.setId(3);
        ...
        SubcategoriaDAO dao=new SubcategoriaDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_subcategoria()));
