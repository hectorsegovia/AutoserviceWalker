...
import Modelos.DAOIMPL.FamiliasDAOIMPL;
 ...
 * @author AspireES15
 */
public class FamiliaCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FamiliasDTO dto = jsonAObjeto.fromJson(json, FamiliasDTO.class);
       ...
       // dto.setId(3);
        ...
        FamiliasDAO dao=new FamiliasDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_familia()));
