...
import Modelos.DAOIMPL.CiudadesDAOIMPL;
 ...
 * @author AspireES15
 */
public class CiudadCTRL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        CiudadesDTO dto = jsonAObjeto.fromJson(json, CiudadesDTO.class);
       ...
       // dto.setId(3);
        ...
        CiudadesDAO dao=new CiudadesDAOIMPL();
        ...
        switch (dto.getBandera()) {
            ...
            case 5:
                response.setContentType("application/json, charset=UTF-8");
                String dato= jsonAObjeto.toJson(dao.consultarSegunId(dto.getId_ciudad()));
